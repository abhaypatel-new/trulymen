                            ...
                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td> <div class="action-btn bg-primary ms-2" style="font-size:12px;">
                                                   <?php echo e($department->id); ?></div></td>
                                    <td><?php echo e(!empty($department->branch)?$department->branch->name:''); ?></td>
                                    <td><?php echo e($department->name); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($department->created_at)->format('d M Y, g:i A D')); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($department->updated_at)->format('d M Y, g:i A D')); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217475692/domains/truelymatch.com/public_html/trumen/resources/views/department/index.blade.php ENDPATH**/ ?>
                ...
                <?php if(Gate::check('manage lead') ||
                    ...
                    <li
                        ...
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                                ...
                                class="dash-mtext"><?php echo e(__('Sales')); ?> & <?php echo e(__('CRM System')); ?></span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul
        ...
        <?php if(!empty($userPlan) &&  $userPlan->pos == 1): ?>
            <?php if(Gate::check('manage warehouse') ||
                ...
                <li
                    ...
                    <a href="#!" class="dash-link"><span class="dash-micon"><i
                                class="ti ti-layers-difference"></i></span><span
                            class="dash-mtext"><?php echo e(__('Purchase')); ?> & <?php echo e(__('Management')); ?></span><span class="dash-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul
                    ...
                    <ul class="dash-submenu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage project')): ?>
                            <li
                                ...
                                <a class="dash-link" href="<?php echo e(route('projects.index')); ?>"><?php echo e(__('Manufacturing')); ?></a>
                            </li>
                        <?php endif; ?>

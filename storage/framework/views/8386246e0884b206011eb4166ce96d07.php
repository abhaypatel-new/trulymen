                    ...
                    <div class="table-responsive">
                        <table class="table datatable">
                            ...
                            <tr>
                                ...
                                <th><?php echo e(__('Created DateTime')); ?></th>
                                <th><?php echo e(__('Updated DateTime')); ?></th>
                            ...
                            <?php $__currentLoopData = $designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $designation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <tr>
                                    <td> <div class="action-btn bg-primary ms-2" style="font-size:12px;">
                                                   <?php echo e($designation->id); ?></div></td>
                                    <td><?php echo e(!empty($department->name)?$department->name:''); ?></td>
                                    <td><?php echo e($designation->name); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($designation->created_at)->format('d M Y, g:i A D')); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($designation->updated_at)->format('d M Y, g:i A D')); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217475692/domains/truelymatch.com/public_html/trumen/resources/views/designation/index.blade.php ENDPATH**/ ?>
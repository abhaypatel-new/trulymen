                            ...
                            @foreach ($designations as $designation)
                                ...
                                <tr>
                                    <td> <div class="action-btn bg-primary ms-2" style="font-size:12px;">
                                                   {{ $designation->id }}</div></td>
                                    <td>{{ !empty($department->name)?$department->name:'' }}</td>
                                    <td>{{ $designation->name }}</td>
                                    <td>{{ \Carbon\Carbon::parse($designation->created_at)->format('d M Y, g:i A D')}}</td>
                                    <td>{{ \Carbon\Carbon::parse($designation->updated_at)->format('d M Y, g:i A D') }}</td>

...
@section('action-btn')
    <div class="float-end">
        ...
        @if($quotation->is_order == 0)<a href="{{ route('quotation.status', ['id' => $quotation->id, 'status' => 'order'])}}" class="btn btn-primary">{{__('Change to Order')}}</a>@elseif($quotation->is_order == 1 && $quotation->is_jobcard == 0)
        ...
        @else
        <a href="{{ route('quotation.status', ['id' => $quotation->id, 'status' => 'is_jobcard'])}}" class="btn btn-primary" disabled>{{__('Order Rejected')}}</a>
        @endif
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="lead-sidenav" style="flex-direction: unset;">
                            ...
                            @if(Auth::user()->type != 'client')
                                <div data-target="content4" class="list-group-item list-group-item-action border-0 tab" style="cursor: pointer;border-bottom-left-radius: unset !important;border-top-left-radius: inherit;border-top-right-radius: inherit;;border-bottom-right-radius: unset !important;
">| {{__('Job Card')}}
                ...
                <div class="card-body">
                    <div class="row mt-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 text-end">
                            <h4 class="invoice-number">{{ $quotation->is_revised != null?Auth::user()->quotationNumberFormat($quotation->quotation_id).'RV':Auth::user()->quotationNumberFormat($quotation->quotation_id) }}</h4>
                        </div>

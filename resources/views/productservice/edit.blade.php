...
<div class="modal-body" style="margin-top: 25px;">
   ...
   {{-- <div class="row">
       ...
       <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('hsn_code', __('Material Ordering Code'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                {{ Form::text('hsn_code',null, array('class' => 'form-control','required'=>'required')) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="form-group  col-md-6">
            {{ Form::label('other_cost', __('Other Cost'),['class'=>'form-label']) }}
            {{ Form::text('other_cost',null, array('class' => 'form-control')) }}
        </div>
        <div class="form-group  col-md-6">
            {{ Form::label('labor_charge', __('Labor Charge'),['class'=>'form-label']) }}
            {{ Form::text('labor_charge',null, array('class' => 'form-control')) }}
        </div>
     ...
     <div class="row shadow p-3 mb-5 bg-white rounded">
         ...
         <div class="col-md-4">
            <div class="form-group">
                ...
                {{ Form::text('purchase_price', $productService->purchase_price, array('class' => 'form-control','required'=>'required', 'readonly', 'id'=>'material_cost')) }}
            </div>
        </div>
         <div class="col-md-4">
            <div class="form-group">
                {{ Form::label('labor_charge', __('Labor Cost'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                {{ Form::number('labor_charge',  $productService->labor_charge, array('class' => 'form-control number-input','required'=>'required','step'=>'1','min'=> '0','max'=>'1000', 'id'=>'labor_charge')) }}
            </div>
        </div>
         <div class="col-md-4">
            <div class="form-group">
                {{ Form::label('other_cost', __('Other Cost'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                {{ Form::number('other_cost', $productService->other_cost, array('class' => 'form-control number-input','required'=>'required','step'=>'1','min'=> '0','max'=>'1000', 'id'=>'other_cost')) }}
            </div>
        </div>
         <div class="col-md-4">
            <div class="form-group">
                {{ Form::label('grand_total', __('Total'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                {{ Form::text('sale_price',  $productService->sale_price, array('class' => 'form-control','required'=>'required','step'=>'1','min'=> '0', 'id'=>'grand_total')) }}
            </div>
        </div>
        <div class="form-group  col-md-12">
            {{ Form::label('description', __('Description'),['class'=>'form-label']) }}

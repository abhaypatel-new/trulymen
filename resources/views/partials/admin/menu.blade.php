                    ...
                    <ul
                        ...
                        @can('manage warehouse')
                            <li
                                ...
                                <a class="dash-link" href="#">{{ __('Vendors') }}</a>
                            </li>
                        @endcan
                        @can('manage purchase')
                            <li
                                ...
                                <a class="dash-link" href="#">{{ __('Order request') }}</a>
                            </li>
                        @endcan
                        @can('manage quotation')
                         <li
                                class="dash-item {{ Request::route()->getName() == 'pos.report' || Request::route()->getName() == 'pos.show' ? ' active' : '' }}">
                                <a class="dash-link" href="{{ route('pos.report') }}">{{ __('Indentan order') }}</a>
                            </li>
                      ...
                      {{--  @can('manage pos')
                        ...
                        @endcan--}}
                            <li
                                class="dash-item {{ Request::route()->getName() == 'pos-print-setting' ? ' active' : '' }}">
                                <a class="dash-link"
                                    href="{{ route('pos.print.setting') }}">{{ __('Return orders') }}</a>
                            </li>
                     ...
                     @if (Gate::check('manage product & service'))
                        <li class="dash-item {{ Request::segment(1) == 'groups' ? 'active' : '' }}">
                            <a href="{{ route('groups.index') }}"
                                class="dash-link">{{ __('Specification Groups') }}
                            </a>
                        </li>
                    @endif
                </ul>
                ...
                <li
                    ...
                    <ul
                        ...
                        @can('manage warehouse')
                            <li
                                class="dash-item {{ Request::route()->getName() == 'warehouse.index' || Request::route()->getName() == 'warehouse.show' ? ' active' : '' }}">
                                <a class="dash-link" href="#">{{ __('Material Stock') }}</a>
                            </li>
                        @endcan
                        @can('manage purchase')
                                     <li
